...
import projectLogoVideo from '../videos/PandaCap.png';
import pandaImage from '../background/panda.png';
...
const Home = () => {
  ...
  return (
    <div className={styles.topContainer}>
      <img id="bg-video" src={projectLogoVideo}/>
      ...
      <div className={styles.info}>
        ...
        <img className={styles.panda} src={pandaImage} alt="Cat" />
          <h3>
